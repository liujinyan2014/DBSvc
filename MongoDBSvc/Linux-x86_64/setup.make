...
#   use SniperKernel v*  (no_version_directory)
# use Python v* Externals (no_version_directory)
# use Mongo v* Externals (no_version_directory)
#   use Boost v* Externals (no_version_directory)
# use Boost v* Externals (no_version_directory)
...
use CLHEP v0 Externals (/home/liujy/juno/ExternalInterface)
use ROOT v0 Externals (/home/liujy/juno/ExternalInterface)
use Python v0 Externals (/home/liujy/juno/ExternalInterface)
use Boost v0 Externals (/home/liujy/juno/ExternalInterface)
use Mongo v0 Externals (/home/liujy/juno/ExternalInterface)
use SniperPolicy v0  (/home/liujy/juno/sniper)
use SniperKernel v2  (/home/liujy/juno/sniper)
use DatabaseSvc v0 Database (/home/liujy/juno/offline)
----------> tags
...
----------> CMTPATH
# Add path /home/liujy/juno/offline from initialization
# Add path /home/liujy/juno/sniper from ProjectPath
