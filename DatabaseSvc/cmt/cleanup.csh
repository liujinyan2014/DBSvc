...
${CMTROOT}/mgr/cmt cleanup -csh -pack=DatabaseSvc -version=v0 -path=/home/liujy/juno/offline/Database  $* >${cmtDatabaseSvctempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=DatabaseSvc -version=v0 -path=/home/liujy/juno/offline/Database  $* >${cmtDatabaseSvctempfile}"
