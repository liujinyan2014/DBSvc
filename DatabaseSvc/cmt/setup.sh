...
${CMTROOT}/mgr/cmt setup -sh -pack=DatabaseSvc -version=v0 -path=/home/liujy/juno/offline/Database  -no_cleanup $* >${cmtDatabaseSvctempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/mgr/cmt setup -sh -pack=DatabaseSvc -version=v0 -path=/home/liujy/juno/offline/Database  -no_cleanup $* >${cmtDatabaseSvctempfile}"
  cmtsetupstatus=2
